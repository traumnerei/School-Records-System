...
{
    public partial class ManageStudentD : UserControl, IRefreshable

    {
        ...
        private void dgvStudents_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvStudents.Columns[e.ColumnIndex].Name == "ViewCourses" && e.RowIndex >= 0)
            {
                ...
                new ViewCourseEnrolledD(userId, true).ShowDialog();
            }
        }   
        ...
        private void LoadStudents()
        {
            using (MySqlConnection conn = new MySqlConnection(_connectionString))
            {
                ...
                dgvStudents.Columns.Clear(); // Clear old columns
        ...
        private void ManageStudentD_Load(object sender, EventArgs e)
        {
            LoadStudents();
        }
